			...
			<div class="col-sm-4">
            	...
            	<div class="portlet">
					...
					<div class="portlet-content">
						...
						<form id="validate-enhanced" method="post" action="" class="form parsley-form">
							{{ csrf_field() }}
							<div class="row">
								<div class="form-group col-md-12">	
									<label for="validateSelect">Tên nhóm:</label>
		                            <input class="form-control" name="title" type="text" value="{{ $group->title }}">
								</div>
								<div class="form-group col-md-12">
